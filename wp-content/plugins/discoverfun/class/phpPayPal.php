...
class phpPayPal { 
    ...
    */
    ...
    //  SANDBOX
    private $API_USERNAME = 'philwe_1361339970_biz_api1.gmail.com';
    ...
    */
    ...
    //  SANDBOX
    private $API_PASSWORD = '1361339990';
    ...
    */
    ...
    //  SANDBOX
    private $API_SIGNATURE = 'AHq2u1Ol7PDPv5GFSdxtupDKfQeUAxlxQfp2VvgTgX3NZX98MoDf37LO';
    ...
    */
    ...
    /* Define the Reutrn and Cancel URLs. 
       ...
       */
    private $RETURN_URL = 'http://localhost/discoverfun/process-payment/'; //get_page_link(10); 
    private $CANCEL_URL = 'http://localhost/discoverfun/process-payment/'; //get_page_link(110);
    ...
    */
    ...
    function SetExpressCheckout()
        ...
        //$nvpstr = $this->generateNVPString('SetExpressCheckout');
            $nvpstr =   '&CURRENCYCODE='.urlencode($PayPalCurrencyCode).
                        '&PAYMENTACTION=Sale'.
                        '&ALLOWNOTE=1'.
                        '&PAYMENTREQUEST_0_CURRENCYCODE=USD'.//.urlencode($PayPalCurrencyCode).
                        '&PAYMENTREQUEST_0_AMT='.urlencode($this->item_price).
                        '&PAYMENTREQUEST_0_ITEMAMT='.urlencode($this->amount_total). 
                        '&L_PAYMENTREQUEST_0_QTY0='. urlencode($this->item_qty).
                        '&L_PAYMENTREQUEST_0_AMT0='.urlencode($this->item_price).
                        '&L_PAYMENTREQUEST_0_NAME0='.urlencode($this->item_name).
                        '&L_PAYMENTREQUEST_0_NUMBER0='.urlencode($this->item_number).
                        '&AMT='.urlencode($this->amount_total).             
